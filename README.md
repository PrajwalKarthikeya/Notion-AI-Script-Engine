# ✍️ Script-to-Workspace AI Engine
...
- **Database:** Notion API
- **Language:** Python
- **Logic:** Pydantic & Instructor for Structured Data

## 🔒 Privacy First
By using a local LLM, this engine ensures that sensitive intellectual property (your scripts) stays on your machine and is never sent to third-party AI providers.
